# AGENTS.md — hacker-house-medellin/hhm-mcp-server.rs
...
- GitHub org: [`hacker-house-medellin`](https://github.com/hacker-house-medellin)
- Repository: [`hacker-house-medellin/hhm-mcp-server.rs`](https://github.com/hacker-house-medellin/hhm-mcp-server.rs)
- Local checkout: `~/codes/hacker-house-medellin/hhm-mcp-server.rs`
...
- Sibling test org: `github.com/hacker-house-medellin-test` (external/e2e coverage and extra GHA minutes)
- Slack workspace: oresoftware-workspace.slack.com
- Kind: product MCP server for this GitHub org
- Package / service name: `hhm-mcp-server`
